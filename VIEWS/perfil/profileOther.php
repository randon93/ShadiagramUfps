...
-->
		...
		<div class="container-fluid bg-light">
		  ...
		  <div class="col-sm-8">
		  	<br>
		  	<br>
		  	<p><strong><?php echo "@".$_SESSION['VISIT']->getAlias(); ?> &nbsp&nbsp&nbsp</strong> <button type="button" class="btn btn-outline-secondary">Editar Perfil</button> <button type="button" class="btn" data-toggle="modal" data-target="#modalconf"><img src="<?php echo constant('URL');?>public/img/recursos/ajustes.png"></button></p>
		  	...
		  	<p><strong><?php echo $_SESSION['VISIT']->getNombre(); ?></strong></p>
				<p><?php echo $_SESSION['VISIT']->getResena(); ?></p>
				<hr/>
		    ...
		    <div class="modal-dialog">
		      <div class="modal-content">
		        ...
		        <div class="modal-body">
		         ...
		         <div><img src="<?php echo constant('URL');?>public/img/recursos/usuario2.png"><strong>&nbspMamorro11</strong><div style="float: right;"><button type="button" class="btn btn-primary">Seguir</button></div></div>
		        </div>
		        <div class="modal-body">
		          <img src="<?php echo constant('URL');?>public/img/recursos/usuario2.png"><strong>&nbspBrandom15</strong><div style="float: right;"><button type="button" class="btn btn-primary">Seguir</button></div></div>

		        <div class="modal-body">
		          <img src="<?php echo constant('URL');?>public/img/recursos/usuario2.png"><strong>&nbspMessi10</strong><div style="float: right;"><button type="button" class="btn btn-light">Siguiendo</button></div></div>
		   ...
		   <div class="modal" id="sigui">
		    <div class="modal-dialog">
		      <div class="modal-content">
		        ...
		        <div class="modal-body">
		          <img src="<?php echo constant('URL');?>public/img/recursos/usuario2.png"><strong>&nbspMessi10</strong><div style="float: right;"><button type="button" class="btn btn-light">Siguiendo</button></div>
		      </div>
	...
	<!--	</div> -->
		<!--Fin MODAL SIGUIENDO -->
		  ...
		  <!-- The Modal perfil -->
		<div class="modal" id="modalpublicacion">  <!-- MODAL FOTO COMENTARIOS -->
		  <div class="modal-dialog modal-lg">
		    <div class="modal-content">
		      ...
		      <div class="container">
		         ...
		         <div class="col-sm-5"><img src="<?php echo constant('URL');?>public/img/recursos/usuario2.png"><strong> &nbsp&nbspBrandomperico15</strong><button type="button" class="close" data-dismiss="modal">&times;</button> <hr>
