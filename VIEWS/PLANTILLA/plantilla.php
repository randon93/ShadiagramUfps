...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0" method="post" action="<?php echo constant('URL');?>perfil/buscarUsuarios">
          <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" name="searchUser" required>
          <button class="btn btn-outline-success my-2 my-sm-0" type="submit" data-toggle="modal" data-target="#exampleModalCenter">Buscar</button>
        </form>
      </div>
    </nav>
    <!-- **************************************************************** -->
   ...
   <!-- **************************************************************** -->
    ...
    <script type='text/javascript'>  $('#exampleModalCenter').modal('show');  </script>
